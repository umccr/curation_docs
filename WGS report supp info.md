...
- VEP - Variant Effect Predictor (v101)
- GENCODE - reference gene annotation and experimental validation (release 35/19)
- dbNSFP - Database of non-synonymous functional predictions (20200616 (v4.1))
- Pfam - Collection of protein families/domains (2020_05 (v33.1))
- TCGA - The Cancer Genome Atlas - somatic mutations (20200722 (v25))
- ICGC-PCAWG - ICGC-Pancancer Analysis of Whole Genomes - somatic mutations (2020_01)
- TCGA-PCDM - Putative Cancer Driver Mutations on multiple discovery approaches (2019)
- UniProtKB - Resource of protein sequence and functional information (2020_04)
- CORUM - Resource of mammalian protein complexes (20180903 (release 3.0))
- gnomAD - Germline variant frequencies exome-wide (r2.1 (October 2018))
- COSMIC - Catalogue of somatic mutations in cancer (90)
- dbSNP - Database of short genetic variants (153)
- 1000Genomes - Germline variant frequencies genome-wide (20130502 (phase 3))
- DisGenet - Database of gene-disease associations (2020_05 (v7.0))
...
- ClinVar - Database of genomic variants of clinical significance (20200803)
- CancerMine - Literature database tumor suppressor/oncogenes (20200908 (release 28))
- OncoTree - Ontology for standardization of cancer type diagnosis (2020_04_01)
- DiseaseOntology - Standardized ontology for human disease (20200915)
- EFO - Experimental Factor Ontology (v3.22)
- OncoScore - Literature-based ranking of gene-cancer association (20191227)
- OpenTargetPlatform - Data integration for access to drug targets (2020_06)
- ChEMBL - Manually curated database of bioactive molecules (20200518 (v27))
- KEGG - Knowledgebase molecular interaction, reaction and relation networks (20200910)
- CIViC - Clinical interpretations of variants in cancer (20200920)
